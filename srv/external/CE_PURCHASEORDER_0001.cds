/* checksum : 8355291aa22a5195307a0f6c0781f669 */
@cds.external : true
...
service CE_PURCHASEORDER_0001 {
  ...
  entity PurchaseOrder {
    ...
    @Common.Composition : true
    _PurchaseOrderNote : Composition of many PurchaseOrderNote {  };
    @Common.Composition : true
    _PurchaseOrderPartner : Composition of many PurchaseOrderPartner {  };
    @Common.Composition : true
    _SupplierAddress : Composition of one PurchaseOrderSupplierAddress {  };
  } actions {
    function GetOutputBinaryData(
      _it : $self not null
    ) returns D_PurOrdGetOutputBinaryDataR not null;
  };
  ...
  entity PurchaseOrderInvoicingPlan {
    ...
    SAP__Messages : many SAP__Message not null;
    @Common.Composition : true
    _POInvoicingPlanItem : Composition of many PurchaseOrderInvoicingPlanItem {  };
    _PurchaseOrder : Association to one PurchaseOrder {  };
    _PurchaseOrderItem : Association to one PurchaseOrderItem {  };
  };
  ...
  entity PurchaseOrderItem {
    ...
    SAP__Messages : many SAP__Message not null;
    @Common.Composition : true
    _DeliveryAddress : Composition of one PurOrderItemDeliveryAddress {  };
    _PurchaseOrder : Association to one PurchaseOrder {  };
    @Common.Composition : true
    @Validation.MaxItems : 1
    _PurchaseOrderInvoicingPlan : Composition of many PurchaseOrderInvoicingPlan {  };
    @Common.Composition : true
    _PurchaseOrderItemNote : Composition of many PurchaseOrderItemNote {  };
    @Common.Composition : true
    _PurchaseOrderScheduleLineTP : Composition of many PurchaseOrderScheduleLine {  };
    @Common.Composition : true
    _PurOrdAccountAssignment : Composition of many PurchaseOrderAccountAssignment {  };
    @Common.Composition : true
    _PurOrdPricingElement : Composition of many PurOrderItemPricingElement {  };
  };
  ...
  entity PurchaseOrderScheduleLine {
    ...
    _PurchaseOrderItem : Association to one PurchaseOrderItem {  };
    @Common.Composition : true
    _SubcontractingComponent : Composition of many POSubcontractingComponent {  };
  };
