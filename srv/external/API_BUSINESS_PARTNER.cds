/* checksum : 47dc0436dbac6eaff8320e3bedec2c01 */
@cds.external : true
...
@cds.external : true
type API_BUSINESS_PARTNER.DuplicateCheckResult {
...
@cds.external : true
function API_BUSINESS_PARTNER.DuplicateCheck(
  Input : LargeString
) returns many API_BUSINESS_PARTNER.DuplicateCheckResult;
